...
import ProjectsKanban from "../pages/Projects/projects-kanban";
import ProjectsCreate from "../pages/Projects/projects-create";

// //Milestones
import MilestonesList from "../pages/Milestones/milestones-list";
import MilestonesKanban from "../pages/Milestones/milestones-kanban";
import MilestonesCreate from "../pages/Milestones/milestones-create";
...
const userRoutes = [
  ...
  { path: "/projects-kanban", component: ProjectsKanban },
  { path: "/projects-create", component: ProjectsCreate },

  // Milestones
  { path: "/milestones-list", component: MilestonesList },
  { path: "/milestones-kanban", component: MilestonesKanban },
  { path: "/milestones-create", component: MilestonesCreate },
